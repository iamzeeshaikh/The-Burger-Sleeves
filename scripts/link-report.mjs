...
const REASONS = new Map([
  ['/product-category/special-sleeves-uses/', 'settled at 4 incoming from Logo Printed, Eco Friendly, Fast Food and Fast Food Sleeves Packaging. The six baseline links were self-referential, every page in the cluster linking up to its own category. Not restored to 6 for the same reason as the materials category: nav and breadcrumbs already reach it from everywhere, and the remaining gap is not worth a forced sentence'],
  ['/product-category/burger-sleeves-materials/', 'settled at 4 incoming from Kraft, Burger Sleeves, Fast Food Sleeves Packaging and one other. The six baseline links were each material page linking up to its own parent category — a closed loop carrying no information. Not restored to 6 deliberately: a category hub also receives navigation and breadcrumb links from every page, and forcing two more contextual links would mean writing sentences that do not need to exist'],
